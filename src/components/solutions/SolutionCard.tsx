  ...
  return (
    <Card
      className={cn(
        ...
        'bg-white dark:bg-[var(--t4i-black)] dark:border-gray-800 dark:hover:border-[var(--t4i-green)]',
        variant === 'compact' && 'p-4',
        className
      )}
      onClick={handleClick}
      ...
      <CardHeader className={cn(
        ...
        <div className="flex items-start justify-between">
          <CardTitle className={cn(
            'text-gray-900 dark:text-[var(--t4i-white)] group-hover:text-[var(--t4i-green)]',
          ...
          <div className="flex flex-wrap gap-1.5">
            {solution.tags.slice(0, 3).map((tag, index) => (
              <Badge
                ...
                variant="secondary"
                className={cn(
                  'text-xs px-2 py-1 bg-gray-100 dark:bg-gray-800',
            ...
            {solution.tags.length > 3 && (
              <Badge
                variant="secondary"
                className="text-xs px-2 py-1 bg-gray-100 dark:bg-gray-800 text-gray-500"
              >
                +{solution.tags.length - 3}
              </Badge>
            )}
